...
object PokeBallModelRepository : VaryingModelRepository<EmptyPokeBallEntity, PokeBallModel>() {
    ...
    override fun registerInBuiltPosers() {
        ...
        inbuilt("blossom_ball", ::PokeBallModel)
        ...
        inbuilt("mana_ball", ::PokeBallModel)
        ...
        inbuilt("prismatic_ball", ::PokeBallModel)
        ...
        inbuilt("skull_ball", ::PokeBallModel)
        inbuilt("shield_ball", ::PokeBallModel)
        inbuilt("sport_ball", ::PokeBallModel)
        inbuilt("strange_ball", ::PokeBallModel)
        inbuilt("sword_ball", ::PokeBallModel)
